# =====================================================
# bot.py — SPACE420OFFICIAL BOT (python-telegram-bot v21+)
# Benvenuto con immagine singola + Navigazione corretta
# =====================================================
...
WELCOME_PHOTO_URL = "https://i.postimg.cc/D0JhvYfw/1230-DD1-F-7504-4131-8-F96-FA4398-A29-B39.jpg"
...
async def cmd_list(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cur = conn.cursor()
    cur.execute(
        "SELECT user_id, username, first_name FROM users ORDER BY joined DESC LIMIT 50"
    )
    rows = cur.fetchall()
    conn.close()
    text = "📜 Ultimi utenti:\n\n" + "\n".join(
...
def main():
    ...
    logger.info("SPACE420OFFICIAL pronto — modalità polling.")
